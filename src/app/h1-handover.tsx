...
const CHECKLIST = [
    { id: '1', label: 'Verify vehicle exterior for scratches / dents', checked: false },
    { id: '2', label: 'Check fuel level matches booking (80%)', checked: false },
    { id: '3', label: 'Record odometer reading (45,210 km)', checked: false },
    { id: '4', label: 'Inspect interior cleanliness', checked: false },
    { id: '5', label: 'Collect physical keys from hub manager', checked: false },
];
    ...
    return (
        <SafeAreaView style={styles.safe} edges={['top']}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Vehicle Handover</Text>
            </View>
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                <View style={styles.carInfo}>
                    ...
                    <View style={styles.carText}>
                        ...
                        <Text style={styles.carSub}>AP 31 HK 8989 · Auto · Petrol</Text>
                    </View>
                </View>
                ...
                <View style={styles.photoUpload}>
                    <View style={styles.uploadHeader}>
                        ...
                        <Text style={styles.uploadTitle}>Photo Evidence</Text>
                    </View>
                    <Text style={styles.uploadSub}>Take photos of all four sides and the dashboard before starting</Text>
                ...
                <Text style={styles.sectionLabel}>PRE-START CHECKLIST</Text>
                ...
                <TouchableOpacity
                    ...
                    activeOpacity={0.85}
                >
                    <Ionicons name="key" size={18} color={'#3A2405'} />
...
const styles = StyleSheet.create({
    ...
    carInfo: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.surface, padding: 14, borderRadius: radius.card },
    ...
    startBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.gold, paddingVertical: 15, borderRadius: radius.button, marginTop: 8 },
    startBtnDisabled: { opacity: 0.4 },
    startBtnText: { fontSize: 14, fontWeight: '700', color: '#3A2405' },
});
