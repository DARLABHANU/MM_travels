    ...
    return (
        <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerTitle}>Set Drop Location</Text>
            </View>

            <View style={styles.mapMock}>
                <Ionicons name="location" size={48} color={colors.danger} style={styles.pin} />
                <Text style={styles.mapText}>Drag Map to Set Destination</Text>
            </View>

            <View style={styles.sheet}>
                <View style={styles.addressBox}>
                    <Text style={styles.addressTitle} numberOfLines={1}>Rushikonda IT Park</Text>
                    <Text style={styles.addressSub} numberOfLines={1}>Hill No 2, Rushikonda, Visakhapatnam</Text>
                </View>
                <TouchableOpacity style={styles.confirmBtn} onPress={() => router.push('/c2-route-preview')}>
                    <Text style={styles.confirmText}>Confirm Drop Location</Text>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
    );
...
const styles = StyleSheet.create({
    ...
    confirmBtn: { backgroundColor: colors.danger, paddingVertical: 16, borderRadius: radius.button, alignItems: 'center' },
